...
function set_settings_ {
    ...
    sed -i "${LINE_PRE}a\[jobname].gbw        [jobname].gbw        Orca MO file" ${SETFILE}
    sed -i "${LINE_PRE}a\[jobname].out        [jobname].out        Orca output file" ${SETFILE}
    sed -i "${LINE_PRE}a\[jobname].inp        [jobname].inp        Orca input file" ${SETFILE}
    ...
    sed -i "${LINE_REF}a\[refname].bas        [refname].bas        Basis set file" ${SETFILE}
    sed -i "${LINE_REF}a\[refname].xyz        [refname].xyz        Coordinate file" ${SETFILE}
    sed -i "${LINE_REF}a\[refname].gbw        [refname].gbw        Orbital file" ${SETFILE}
    sed -i "${LINE_REF}a\[refname].densities  [refname].densities  Electron density file" ${SETFILE}
    sed -i "${LINE_REF}a\[refname].hess       [refname].hess       Hessian matrix file" ${SETFILE}
    sed -i "${LINE_REF}a\[refname].prop       [refname].prop       Properties file" ${SETFILE}
    ...
    sed -i "${LINE_POST}a\[jobname].gbw        [jobname].gbw        Orbital file" ${SETFILE}
    sed -i "${LINE_POST}a\[jobname].densities  [jobname].densities  Electron density file" ${SETFILE}
    sed -i "${LINE_POST}a\[jobname].hess       [jobname].hess       Hessian matrix file" ${SETFILE}
    sed -i "${LINE_POST}a\[jobname].prop       [jobname].prop       Properties file" ${SETFILE}
    sed -i "${LINE_POST}a\[jobname].trj        [jobname].trj        Trajectory file" ${SETFILE}
    sed -i "${LINE_POST}a\[jobname].mdrestart  [jobname].mdrestart  MD restart file" ${SETFILE}
